...
clear all;
close all;
load( 'ERSSTv5_SST_SSTA_SSTA_detrend_lowpass_1979_2024.mat' );
load( 'NECP2_uwind10m_ano_detrend_lowpass_1979_2024.mat' );
...
uwind_detrend_filter_used = squeeze( nanmean( uwind_ano_3D_detrend_filter( id_lon_wind , id_lat_wind , : ) , 2 ) );
...
SSTA_PCE  = SSTA_detrend_3D( id_lon_PCE , id_lat_PCE , : );
...
SSTA_MC  = SSTA_detrend_3D( id_lon_MC , id_lat_MC , : );
...
%
load( 'NECP2_ENSO_contour_zero_line.mat' );
%
...
p.FaceColor = [ 1 1 1 ];%定义区间的填充颜色      
p.EdgeColor = 'none';%定义区间边界的填充颜色，此处不设置
p.FaceAlpha = 0.2;

p1 = fill( fill_x1 , fill_y1 , [ 0.9 0.9 0.9 ] );
p1.FaceColor = [ 0.8 0.8 0.8 ];%定义区间的填充颜色      
p1.EdgeColor = 'none';%定义区间边界的填充颜色，此处不设置
p1.FaceAlpha = 0.4;
p2 = fill( fill_x2 , fill_y2 , [ 0.9 0.9 0.9 ] );
p2.FaceColor = [ 0.8 0.8 0.8 ];%定义区间的填充颜色      
p2.EdgeColor = 'none';%定义区间边界的填充颜色，此处不设置
p2.FaceAlpha = 0.4;
