...
u_psi_ano_down_detrend_fliter_400_600hpa_change  = u_psi_ano_down_detrend_fliter_400_600hpa( : , 6 : end );
u_div_ano_equ_detrend_fliter_400_600hpa          = squeeze( nanmean( u_div_ano_equ_detrend_fliter( : , 1 : 3 , : ) , 2 ) );
u_div_ano_equ_detrend_fliter_400_600hpa_change   = u_div_ano_equ_detrend_fliter_400_600hpa( : , 6 : end );
u_div_ano_equ_detrend_fliter_400_600hpa_change   = u_div_ano_equ_detrend_fliter_400_600hpa_change';
%%

R_earth     = 6371393; % m
dx_distance = 2.5 / 180 * pi * R_earth;
constant    = 9.8 ./ ( R_earth * pi ./ 18);
W_d_ano_El_eastward_move_year_used = NaN( size( u_psi_ano_down_detrend_fliter_400_600hpa_change ) );
for itime = 1 : size( u_psi_ano_down_detrend_fliter_400_600hpa_change , 2 )
    for ilon = 1 : size( u_psi_ano_down_detrend_fliter_400_600hpa_change , 1 )
        if ilon == 1
            d_psi = u_psi_ano_down_detrend_fliter_400_600hpa_change( 2 , itime ) - u_psi_ano_down_detrend_fliter_400_600hpa_change( end , itime );
        elseif ilon == size( u_psi_ano_down_detrend_fliter_400_600hpa_change , 1 )
            d_psi = u_psi_ano_down_detrend_fliter_400_600hpa_change( 1 , itime ) - u_psi_ano_down_detrend_fliter_400_600hpa_change( end-1 , itime );
        else
            d_psi = u_psi_ano_down_detrend_fliter_400_600hpa_change( ilon + 1 , itime ) - u_psi_ano_down_detrend_fliter_400_600hpa_change( ilon - 1 , itime );
        end
...
[ C1 , H1 ] = contourf( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_1994_start : year_1994_last )' ./ 1e9 , label , 'LineStyle', 'none' );
clear C1 H1
hold on
[ C2 , H2 ] = contour( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_1994_start : year_1994_last )' ./ 1e9 , [ 0 , 0 ] , 'k--' );
set( H2 , 'LineWidth' , 4 );
...
[ C1 , H1 ] = contourf( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2022_start : year_2022_last )' ./ 1e9 , label , 'LineStyle', 'none' );
clear C1 H1
hold on
[ C2 , H2 ] = contour( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2022_start : year_2022_last )' ./ 1e9 , [ 0 , 0 ] , 'k--' );
set( H2 , 'LineWidth' , 4 );
plot( [ 100 160 ] , [ 7 19 ] , 'color' , [ 0 255 0 ]/255 , 'LineStyle' , '-' , 'LineWidth' , 6 );     
...
[ C1 , H1 ] = contourf( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2004_start : year_2004_last )' ./ 1e9 , label , 'LineStyle', 'none' );
clear C1 H1
hold on
[ C2 , H2 ] = contour( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2004_start : year_2004_last )' ./ 1e9 , [ 0 , 0 ] , 'k--' );
set( H2 , 'LineWidth' , 4 );
plot( [ 100 160 ] , [ 7 19 ] , 'color' , [ 0 255 0 ]/255 , 'LineStyle' , '-' , 'LineWidth' , 6 );     
...
[ C1 , H1 ] = contourf( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2000_start : year_2000_last )' ./ 1e9 , label , 'LineStyle', 'none' );
clear C1 H1
hold on
[ C2 , H2 ] = contour( lon , 1:1:19 , u_psi_ano_down_detrend_fliter_400_600hpa_change( : , year_2000_start : year_2000_last )' ./ 1e9 , [ 0 , 0 ] , 'k--' );
set( H2 , 'LineWidth' , 4 );
plot( [ 100 160 ] , [ 7 19 ] , 'color' , [  0 255 0 ]/255 , 'LineStyle' , '-' , 'LineWidth' , 6 );     
...
cb.Position = [0.12 0.05 0.76 0.03];   % [x y width height] 需微调
cb.Label.String = '×10^9 kg·s^{-1}';
cb.Label.FontSize = 22;
cb.Label.FontName = 'Times New Roman';
cb.Label.Rotation = 0;                 % 水平文字
cb.Label.Units = 'normalized';         % 用归一化坐标摆放
