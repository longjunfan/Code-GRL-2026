...
load( '../data store/NECP2_u_div_ano_pres_detrend_lowpass_197901_202412.mat' );
load( '../data store/NECP2_upsi_cli_pres_197901_202412.mat' );
lon_upsi = lon;
lat_upsi = lat;
lev_upsi = lev;
clear lon lev lat
...
%%
upsi_ano_El_Eastward_move_year_Dec_0     = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 ) , 3 );
upsi_ano_El_Eastward_move_year_May_1     = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_May_1 ) , 3 );
upsi_ano_El_Eastward_move_year_Dec_1     = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 ) , 3 );
upsi_cli_ano_El_Eastward_move_year_Dec_0 = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 ) , 3 ) + u_psi_cli_down;
upsi_cli_ano_El_Eastward_move_year_May_1 = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_May_1 ) , 3 ) + u_psi_cli_down;
upsi_cli_ano_El_Eastward_move_year_Dec_1 = mean( u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 ) , 3 ) + u_psi_cli_down;

upsi_ano_El_Eastward_move_year_Dec_0_all_year = u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 );
upsi_ano_El_Eastward_move_year_May_1_all_year = u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_May_1 );
upsi_ano_El_Eastward_move_year_Dec_1_all_year = u_psi_ano_down_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 );
% upsi student t-test
...
%
%%
u_div_ano_El_Eastward_move_year_Dec_0     = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 ) , 3 );
u_div_ano_El_Eastward_move_year_May_1     = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_May_1 ) , 3 );
u_div_ano_El_Eastward_move_year_Dec_1     = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 ) , 3 );
u_div_cli_ano_El_Eastward_move_year_Dec_0 = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 ) , 3 ) + u_div_year_cli_equ;
u_div_cli_ano_El_Eastward_move_year_May_1 = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_May_1 ) , 3 ) + u_div_year_cli_equ;
u_div_cli_ano_El_Eastward_move_year_Dec_1 = mean( u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 ) , 3 ) + u_div_year_cli_equ;


u_div_ano_El_Eastward_move_year_Dec_0_all_year = u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_0 );
u_div_ano_El_Eastward_move_year_May_1_all_year = u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_May_1 );
u_div_ano_El_Eastward_move_year_Dec_1_all_year = u_div_ano_equ_detrend_filter( : , : , id_El_Eastward_move_year_Dec_1 );
...
W_div_ano = NaN( size( u_psi_ano_down_detrend_filter ) );
for itime = 1 : size( u_psi_ano_down_detrend_filter , 3 )
    for ilev = 1 :size( u_psi_ano_down_detrend_filter , 2 )
        for ilon = 1 : size( u_psi_ano_down_detrend_filter , 1 )
            if ilon == 1
                d_psi = u_psi_ano_down_detrend_filter( 2 , ilev , itime ) - u_psi_ano_down_detrend_filter( end , ilev , itime );
            elseif ilon == size( u_psi_ano_down_detrend_filter , 1 )
                d_psi = u_psi_ano_down_detrend_filter( 1 , ilev , itime ) - u_psi_ano_down_detrend_filter( end-1 , ilev , itime );
            else
                d_psi = u_psi_ano_down_detrend_filter( ilon + 1 , ilev , itime ) - u_psi_ano_down_detrend_filter( ilon - 1 , ilev , itime );
            end
...
p = [ lev_upsi , log( 1000 ./ lev_upsi ) ]; % y = ln(p0/p) = ln(1000/p)
...
n=0.01;   
for itime = [ 2 , 3 , 4 , 5 , 6 , 7 , 8 , 10 , 11 , 12 ] 
